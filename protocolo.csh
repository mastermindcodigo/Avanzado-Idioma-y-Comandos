...
# contiene la versión avanzada del proyecto Master Mind sólo con la mejora de
...
# la opción de pasar argumentos al programa por línea de comando, y los cambios
# asociados a ella en la funcionalidad "Jugar partida"
#
# 
#
...
echo "la versión avanzada del proyecto Master Mind sólo con la mejora de"
echo "la funcionalidad 'Establecer idioma', y los cambios asociados a ella en"
echo "todas las funcionalidades que muestren información por pantalla y"
echo "la opción de pasar argumentos al programa por línea de comando, y los"
echo "cambios asociados a ella en la funcionalidad 'Jugar partida'"
echo
